      ...
      <div className="flex w-full gap-12 pt-[70px] pb-[80px] justify-center">
        ...
        <div className="flex flex-col  gap-9 w-[600px]">
          ...
          <div className="flex text-5xl justify-evenly">
            <div className="w-[40px] h-[40px] bg-gray-200 animate-pulse"></div>
            <div className="w-[40px] h-[40px] bg-gray-200 animate-pulse"></div>
            <div className="w-[40px] h-[40px] bg-gray-200 animate-pulse"></div>
          </div>
          ...
          <div className="w-[400px] h-[40px] bg-gray-200 animate-pulse mt-3 ml-auto"></div>

          <div className="flex justify-around ml-4 mt-4">
            <div className="w-[250px] h-[60px] bg-gray-200 animate-pulse"></div>
            <div className="w-[250px] h-[60px] bg-gray-200 animate-pulse"></div>
          </div>
        </div>
      </div>
